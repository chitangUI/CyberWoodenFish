...
func newScore(db *gorm.DB, opts ...gen.DOOption) score {
	...
	_score.UserId = field.NewUint(tableName, "user_id")
	_score.Score = field.NewUint64(tableName, "score")
	_score.MaxCombo = field.NewUint64(tableName, "max_combo")
...
func (s *score) updateTableName(table string) *score {
	...
	s.Score = field.NewUint64(table, "score")
	s.MaxCombo = field.NewUint64(table, "max_combo")
...
func (s *score) fillFieldMap() {
	...
	s.fieldMap["max_combo"] = s.MaxCombo
}
