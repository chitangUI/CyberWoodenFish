...
func newUser(db *gorm.DB, opts ...gen.DOOption) user {
	...
	_user.TelegramId = field.NewUint64(tableName, "telegram_id")
	_user.ActiveStats = field.NewUint8(tableName, "active_stats")
...
type user struct {
	...
	TelegramId  field.Uint64
	ActiveStats field.Uint8
...
func (u *user) updateTableName(table string) *user {
	...
	u.TelegramId = field.NewUint64(table, "telegram_id")
	u.ActiveStats = field.NewUint8(table, "active_stats")
...
func (u *user) fillFieldMap() {
	...
	u.fieldMap["active_stats"] = u.ActiveStats
}
